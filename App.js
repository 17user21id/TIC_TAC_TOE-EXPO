  ...
  render(){
    return(
      <View style={styles.container}>
          ...
          <TouchableOpacity style={{margin:30,flexDirection:"row",paddingLeft:36, paddingTop:10 , paddingBottom:10 , backgroundColor:"#01CBC6",width:200,borderRadius:20}} onPress={()=>this.resetGame()}>
            {/* <Entypo name="controller-jump-to-start" size={40} color="#2B2B52" /> */}
            <Text style={{color:"#2B2B52",fontSize:20 , fontWeight:'bold'}}>Restart Game</Text>
          </TouchableOpacity>   
